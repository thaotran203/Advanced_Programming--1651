...
namespace Coffee_Management_System_1651
{
    class CoffeeShop
    {
        ...
        public void AddMenuItem()
        {
            ...
            Console.Write("Please enter price of the item in Medium size: ");
            double mediumPrice = double.Parse(Console.ReadLine());
            Console.Write("Please enter price of the item in Large size: ");
            double largePrice = double.Parse(Console.ReadLine());

            MenuItems.Add(CoffeeFactory.CreateNewItem(name, largePrice, Size.Large));
            MenuItems.Add(CoffeeFactory.CreateNewItem(name, mediumPrice, Size.Medium));
        ...
        public void PrintMenuCoffee()
        {
            ...
            {
                Console.WriteLine($"|| {i + 1}.  {MenuItems[i].Name,-20}     ||   {MenuItems[i].Size,-10}   ||          {MenuItems[i].Price} USD         ||");
            }
            Console.WriteLine(" ===================================================================================");
        }
